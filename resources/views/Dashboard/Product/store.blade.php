            ...
            <div class="col-md-8">
                <div class="card">
                    ...
                    <div class="card-body">
                        ...
                        <form method="POST" action="{{url('/admin/storeproducts')}}"  enctype="multipart/form-data">
                        ...
                        @csrf
                            ...
                            <div class="row mb-3">
                                ...
                                <div class="col-md-6">
                                    <input id="discription" type="text" class="form-control @error('discription') is-invalid @enderror" name="discription" value="{{ old('discription') }}" autocomplete="discription" required >
